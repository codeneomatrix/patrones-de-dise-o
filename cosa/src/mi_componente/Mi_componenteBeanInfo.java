 ...
 * @author acer
 */
public class Mi_componenteBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( mi_componente.Mi_componente.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_caracteres = 0;
    private static final int PROPERTY_decimales = 1;
    private static final int PROPERTY_etiqueta = 2;
    private static final int PROPERTY_maximo = 3;
    private static final int PROPERTY_maximod = 4;
    private static final int PROPERTY_minimo = 5;
    private static final int PROPERTY_minimod = 6;
    private static final int PROPERTY_numeros = 7;
    private static final int PROPERTY_valordecimal = 8;
    private static final int PROPERTY_valorentero = 9;
    private static final int PROPERTY_valortexto = 10;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_caracteres] = new PropertyDescriptor ( "caracteres", mi_componente.Mi_componente.class, "getcaracteres", "setcaracteres" ); // NOI18N
            properties[PROPERTY_decimales] = new PropertyDescriptor ( "decimales", mi_componente.Mi_componente.class, "getdecimales", "setdecimales" ); // NOI18N
            properties[PROPERTY_etiqueta] = new PropertyDescriptor ( "etiqueta", mi_componente.Mi_componente.class, "getetiqueta", "setetiqueta" ); // NOI18N
            properties[PROPERTY_maximo] = new PropertyDescriptor ( "maximo", mi_componente.Mi_componente.class, "getmaximo", "setmaximo" ); // NOI18N
            properties[PROPERTY_maximod] = new PropertyDescriptor ( "maximod", mi_componente.Mi_componente.class, "getmaximod", "setmaximod" ); // NOI18N
            properties[PROPERTY_minimo] = new PropertyDescriptor ( "minimo", mi_componente.Mi_componente.class, "getminimo", "setminimo" ); // NOI18N
            properties[PROPERTY_minimod] = new PropertyDescriptor ( "minimod", mi_componente.Mi_componente.class, "getminimod", "setminimod" ); // NOI18N
            properties[PROPERTY_numeros] = new PropertyDescriptor ( "numeros", mi_componente.Mi_componente.class, "getnumeros", "setnumeros" ); // NOI18N
            properties[PROPERTY_valordecimal] = new PropertyDescriptor ( "valordecimal", mi_componente.Mi_componente.class, "getvalordecimal", null ); // NOI18N
            properties[PROPERTY_valorentero] = new PropertyDescriptor ( "valorentero", mi_componente.Mi_componente.class, "getvalorentero", null ); // NOI18N
            properties[PROPERTY_valortexto] = new PropertyDescriptor ( "valortexto", mi_componente.Mi_componente.class, "getvalortexto", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", mi_componente.Mi_componente.class, "isVisible", "setVisible" ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( mi_componente.Mi_componente.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( mi_componente.Mi_componente.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( mi_componente.Mi_componente.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( mi_componente.Mi_componente.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( mi_componente.Mi_componente.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( mi_componente.Mi_componente.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( mi_componente.Mi_componente.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( mi_componente.Mi_componente.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( mi_componente.Mi_componente.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( mi_componente.Mi_componente.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( mi_componente.Mi_componente.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( mi_componente.Mi_componente.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( mi_componente.Mi_componente.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_keyPressed73 = 73;
    private static final int METHOD_keyReleased74 = 74;
    private static final int METHOD_keyTyped75 = 75;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_keyPressed73] = new MethodDescriptor(mi_componente.Mi_componente.class.getMethod("keyPressed", new Class[] {java.awt.event.KeyEvent.class})); // NOI18N
            methods[METHOD_keyPressed73].setDisplayName ( "" );
            methods[METHOD_keyReleased74] = new MethodDescriptor(mi_componente.Mi_componente.class.getMethod("keyReleased", new Class[] {java.awt.event.KeyEvent.class})); // NOI18N
            methods[METHOD_keyReleased74].setDisplayName ( "" );
            methods[METHOD_keyTyped75] = new MethodDescriptor(mi_componente.Mi_componente.class.getMethod("keyTyped", new Class[] {java.awt.event.KeyEvent.class})); // NOI18N
            methods[METHOD_keyTyped75].setDisplayName ( "" );
