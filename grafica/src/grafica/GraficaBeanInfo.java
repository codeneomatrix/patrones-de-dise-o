 ...
 * @author acer
 */
public class GraficaBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( grafica.Grafica.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_dato1 = 0;
    private static final int PROPERTY_dato2 = 1;
    private static final int PROPERTY_datos = 2;
    private static final int PROPERTY_enabled = 3;
    private static final int PROPERTY_etiqueta1 = 4;
    private static final int PROPERTY_etiqueta2 = 5;
    private static final int PROPERTY_titulo = 6;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_dato1] = new PropertyDescriptor ( "dato1", grafica.Grafica.class, "getDato1", "setDato1" ); // NOI18N
            properties[PROPERTY_dato2] = new PropertyDescriptor ( "dato2", grafica.Grafica.class, "getDato2", "setDato2" ); // NOI18N
            properties[PROPERTY_datos] = new PropertyDescriptor ( "datos", grafica.Grafica.class, "getDatos", "setDatos" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", grafica.Grafica.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_etiqueta1] = new PropertyDescriptor ( "etiqueta1", grafica.Grafica.class, "getEtiqueta1", "setEtiqueta1" ); // NOI18N
            properties[PROPERTY_etiqueta2] = new PropertyDescriptor ( "etiqueta2", grafica.Grafica.class, "getEtiqueta2", "setEtiqueta2" ); // NOI18N
            properties[PROPERTY_titulo] = new PropertyDescriptor ( "titulo", grafica.Grafica.class, "getTitulo", "setTitulo" ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( grafica.Grafica.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( grafica.Grafica.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( grafica.Grafica.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( grafica.Grafica.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( grafica.Grafica.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( grafica.Grafica.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( grafica.Grafica.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( grafica.Grafica.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( grafica.Grafica.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( grafica.Grafica.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( grafica.Grafica.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( grafica.Grafica.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( grafica.Grafica.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_dibujar24 = 24;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_dibujar24] = new MethodDescriptor(grafica.Grafica.class.getMethod("dibujar", new Class[] {int.class, int.class, int.class, int.class})); // NOI18N
            methods[METHOD_dibujar24].setDisplayName ( "" );
            ...
            methods[METHOD_paint93] = new MethodDescriptor(grafica.Grafica.class.getMethod("paint", new Class[] {java.awt.Graphics.class})); // NOI18N
